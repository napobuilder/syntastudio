            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        animate="visible"
                        exit="exit"
                        className="absolute left-1/2 -translate-x-1/2 sm:left-auto sm:right-0 sm:translate-x-0 mt-2 w-72 origin-top-right bg-black/80 backdrop-blur-lg border border-white/20 rounded-lg shadow-2xl focus:outline-none z-50"
                    >
