            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        animate="visible"
                        exit="exit"
                        className="absolute right-0 mt-2 w-72 max-w-[90vw] origin-top-right bg-black/80 backdrop-blur-lg border border-white/20 rounded-lg shadow-2xl focus:outline-none z-50"
                    >
